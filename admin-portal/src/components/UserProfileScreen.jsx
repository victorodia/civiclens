            ...
            <div className="space-y-4">
                {activeTab === 'overview' && (
                    <div className="space-y-4 animate-in fade-in duration-300">
                        ...
                        <button
                            onClick={onLogout}
                            className="w-full mt-6 py-4 rounded-xl border border-red-200 dark:border-red-900 text-red-600 dark:text-red-400 font-black uppercase tracking-widest text-xs hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                        >
                            Sign Out Session
                        </button>
                    </div>
